...
@PreTrainedConfig.register_subclass("tavla")
@dataclass
class TavlaConfig(PreTrainedConfig):
    """
    Configuration class for TA-VLA (Task-Aware Vision-Language-Action) policy.
    
    TA-VLA extends PI0 with task-aware capabilities and specific data processing
    ...
    # Model architecture (inherits from PI0 base)
    ...
    # Flow matching parameters (same as PI0)
